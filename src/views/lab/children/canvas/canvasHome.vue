<template>
    <div class="CanvasLabHome" ref="CanvasLabHome">
        <div class="intro">
            thisp age is canvas lab home
        </div>
        <div class="leftList">
            ...
            <p @click="selectCanvasName='ballPool'">小球集合</p>
        </div>
...
import ballPool from './ballPool/ballPool.vue';
export default {
    name:'CanvasLabHome',
    components:{
        InputBloom,
    ...
    mounted(){
        let CanvasLabHome = this.$refs.CanvasLabHome;
        this.appHeight = CanvasLabHome.offsetHeight 
    }
}
</script>
